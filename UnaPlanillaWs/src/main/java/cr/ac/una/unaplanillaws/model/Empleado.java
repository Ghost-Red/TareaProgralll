...
@NamedQueries({
    ...
    @NamedQuery(name = "Empleado.findByCedulaNombrePapellido", query = "SELECT e FROM Empleado e WHERE UPPER(e.nombre) like UPPER(:nombre) and UPPER(e.cedula) like :cedula and UPPER(e.primerApellido) like UPPER(:pApellido)", hints = @QueryHint(name = "eclipselink.refresh", value = "true")),
