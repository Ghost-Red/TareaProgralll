...
public class EmployeeAverageSkillController {
    ...
    public EmployeeAverageSkillDto saveCompany(EmployeeAverageSkillDto employeeAverageSkill){
    ...
    public EmployeeAverageSkillDto deleteCompany(@WebParam(name = "id") Long id){
