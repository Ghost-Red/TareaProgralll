...
public class Skill implements Serializable {
    ...
    @Id
    @SequenceGenerator(name = "SKILL_SKILL_ID_GENERATOR", sequenceName = "tarea.SKILL_SEQ", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SKILL_SKILL_ID_GENERATOR")
